  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.feltA, alignItems: "center", justifyContent: "center", padding: 60 }}>
      ...
      <View style={{ flexDirection: "row", gap: 14, marginBottom: 44, alignItems: "flex-end" }}>
        {/* Die showing 2 */}
        <FloatDie floatAmount={3} floatDuration={900} floatDelay={0} staticRotate={12} rockDir={1} style={{ width: 52, height: 52, borderRadius: 9, backgroundColor: "#1a1a1a", borderWidth: 1, borderColor: "#2a2a2a", position: "relative" }}>
        ...
        <FloatDie floatAmount={6} floatDuration={1050} floatDelay={300} staticRotate={-5} rockDir={-1} style={{ width: 80, height: 80, borderRadius: 14, backgroundColor: "#efefef", alignItems: "center", justifyContent: "center" }}>
          <View style={{ width: 14, height: 14, borderRadius: 7, backgroundColor: "#141414" }} />
        </FloatDie>

        {/* Die showing 4 */}
        <FloatDie floatAmount={5} floatDuration={950} floatDelay={150} staticRotate={8} rockDir={1} style={{ width: 64, height: 64, borderRadius: 12, backgroundColor: "#141414", borderWidth: 1, borderColor: "#2a2a2a", padding: 10 }}>
        ...
        {/* Die showing 3 */}
        <FloatDie floatAmount={4} floatDuration={1100} floatDelay={500} staticRotate={-9} rockDir={-1} style={{ width: 56, height: 56, borderRadius: 10, backgroundColor: "#141414", borderWidth: 1, borderColor: "#2a2a2a", padding: 8 }}>
          <View style={{ flex: 1, justifyContent: "space-between" }}>
